        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="rounded bg-navy-50 px-2.5 py-1 text-xs font-bold uppercase tracking-wider text-navy-900 inline-flex items-center gap-1.5 border border-navy-100">
            ...
            <div className="institutional-card group flex flex-col justify-between h-full bg-white border border-[#E5E7EB] rounded-xl overflow-hidden shadow-xs hover:shadow-lg transition-all duration-300 hover:border-navy hover:-translate-y-1">
              ...
              <div className="px-4 sm:px-5 pb-4 pt-1">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center gap-1.5 rounded-md border border-navy-200 bg-navy-50/50 hover:bg-navy hover:text-white px-3 py-2 text-xs font-semibold text-navy-900 transition-all duration-200 group/btn"
                >
